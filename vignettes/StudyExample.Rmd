...
This vignette describes tha application of a risk modeling predictive approach to the assessment of treatmetn effect heterogeneity (HTE) using the `RiskStratifiedEstimation` package. The method involves 4 main steps summarized in Figure \ref{workflow}:
